...
// *************************************adding natural numbers by taking i/p
// from the user***********
...
// int num = 5;
// for (int i = 1; i <= 10; i++){
// System.out.printf("Table of %d : %d * %d = %d%n", num, num, i, num * i); //
// %d only works with printf, not println
// }
// }
// }
...
// public class Loops{
// public static void main(String[] args){ // here when u run this code JVM
// looks for this exact method this is standard signature
// Scanner sc = new Scanner(System.in);
// int n = sc.nextInt();
// int sum = 0;
// for(int i = 0; i < n; i++){
...
// String[] args because when you run a program from the command line These
// values are passed as text Strings. JVM sends them to your
// program like args[0] = "10" , args[1] = "20", args[2] = "30"
// Everything comming from the command line is String by default, not int
// Why not int[] args becasue JVM only knows how to pass String[] not int[] ,
// double[], char[]
// JVM → delivers a packet of text Your program → converts it into int if needed

// *********************** Enhanced for loop in Java : It is used to Iterate
// through arrays or Collections only*****************
