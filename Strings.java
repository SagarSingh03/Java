...
// the sentence.
// String name = sc.nextLine(); // this sc.nextLine will print all the words
// infact it can print the entire sentence also.
...
//         String name1 = "Sagar";
//         String name2 = "Sagar";
//         if (name1 == name2) { // here we are using == but many times it is going to fail and in competition some test cases will not run due 
...
// Substring ***************************** Substrings means finding the smaller part of the big part. 
...
// Another way of finding the strings***********************************************************
// import java.util.*;
// public class Strings{
//     public static void main(String args[]){
